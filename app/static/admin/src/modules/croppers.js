...
layui.define(['jquery','layer','cropper'],function (exports) {
    var $ = layui.jquery
        ...
        "        </div>\n" +
        "        <div class=\"layui-form-mid layui-word-aux\">头像的尺寸限定(saveW)x(saveH)px,大小在500kb以内</div>\n" +
        "    </div>\n" +
        "    <div class=\"layui-row \">\n" +
        ...
        "        <div class=\"layui-col-xs9\" style='padding-right: 10px;'>\n" +
        "            <div class=\"layui-row\">\n" +
    ...
    var obj = {
        render: function(e){
            ...
            html=html.replace('(saveW)',saveW);
            html=html.replace('(saveH)',saveH);
        	$('head').append('<link rel="stylesheet" href="'+layui.cache.base+'css/cropper.css" media="all">');
            $('body').append(html);
